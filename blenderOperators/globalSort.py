"""
Adds Blue Hole Blender Operators [Sort]
"""
...
debugUtils.print_debug_msg('\nLoading Sort Menu and Operators...', show_verbose)
...
class BLUE_HOLE_MT_sort(bpy.types.Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator(SortSelectionOnWorldAxis.bl_idname)
        layout.operator(SearchReplaceNameSelection.bl_idname)
        layout.operator(BatchRenameSelection.bl_idname)
        layout.operator(FlipLastUnderscores.bl_idname)
...
def register():
    # Register Menu
    bpy.utils.register_class(BLUE_HOLE_MT_sort)
    # Register Operators
    for cls in classes:
...
def unregister():
    # Unregister Menu
    bpy.utils.unregister_class(BLUE_HOLE_MT_sort)
...
debugUtils.print_debug_msg('Sort Menu and Operators Loaded!', show_verbose)
